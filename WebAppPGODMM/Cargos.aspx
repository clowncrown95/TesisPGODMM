<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Cargos.aspx.cs" Inherits="WebAppPGODMM.Cargos" %>
    ...
    <div class="form-group">
        <div class="input-group">
            ...
            <Columns>
                ...
                <asp:BoundField HeaderText="Código" DataField="CAR_ID" Visible="true" />
                <asp:BoundField HeaderText="Cargo" DataField="CAR_NOMBRE" Visible="true" />
                <asp:BoundField HeaderText="Descripción" DataField="CAR_DESCRIPCION" Visible="true" />
                <asp:BoundField HeaderText="Crea" DataField="CAR_CREO" Visible="true" />
