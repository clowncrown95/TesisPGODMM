    ...
    <div class="form-group">
        <div class="input-group">
            ...
            <Columns>
                        ...
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu" role="menu" aria-labelledby="menu1">
                                <li role="presentation">
                                    <asp:LinkButton runat="server" CommandArgument='<%#Eval("EST_ID")%>' CommandName="detail"><span class='glyphicon glyphicon-eye-open' aria-hidden='true'></span> Ver</asp:LinkButton></li>
                                <li role="presentation">
                ...
                <asp:BoundField HeaderText="Elimino" DataField="EST_ELIMINO" Visible="true" />
            </Columns>
        </asp:GridView>
    </div>
