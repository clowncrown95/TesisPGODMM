<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EliminarPersona.aspx.cs" Inherits="WebAppPGODMM.EliminarPersona" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <asp:HiddenField runat="server" ID="lblPersonaId" />
    <div class="row">
        <div class="col-md-3">
